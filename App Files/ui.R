...
####################################
	...
	sidebarPanel(width = 3,
		...
		tags$p("Note: Running a new batch of models takes a little time"),
				selectizeInput("compare.ageclass", "Age Class (Some Tabs)", choices = ages.menu.list.multi, selected=ages.menu.list[1]),
		 ...
		 tabsetPanel(type = "tabs",
				  ...
				  tabPanel("Settings",
							...
							tabPanel("Any 1",checkboxInput("m10.use","Include this model",value=FALSE),
											  textInput("m10.name", "Model Label", value = "Any 1", width = "40%"),
											  uiOutput("model_menu_m10"), 
											  numericInput("m10.avgyrs", label=h5("Avg Years (Naive Models)"), value = 5 , min = 1, max = 10, step = 1,   width = "40%"),
											  ...
											  numericInput("m10.kfyear", label=h5("Avg Years for time-varying par (applies to Sibling Regression with Kalman Filter Models)"),
											  						 value = 5 , min = 1, max = 50, step = 1,   width = "40%"),
							...
							tabPanel("Any 2", 
							         ...
							         textInput("m13.name", "Model Label", value = "Any 2", width = "40%"),
							         uiOutput("model_menu_m13"), 
							         numericInput("m13.avgyrs", label=h5("Avg Years (Naive Models)"), value = 5 , min = 1, max = 10, step = 1,   width = "40%"),
						...
						checkboxInput("m14.use","Include this model",value=FALSE),
							         textInput("m14.name", "Model Label", value = "Any 3", width = "40%"),
						            uiOutput("model_menu_m14"), 
							         numericInput("m14.avgyrs", label=h5("Avg Years (Naive Models)"), value = 5 , min = 1, max = 10, step = 1,   width = "40%"),
